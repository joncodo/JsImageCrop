        ...
        CropAreaRectangle.prototype.processMouseMove = function (mouseCurX, mouseCurY) {
            ...
            if (this._areaIsDragging) {
                ...
                switch (this._resizeCtrlIsDragging) {
                    case 0: // Top Left
                        this.setSizeByCorners({x: mouseCurX, y: mouseCurY}, {
                            x: se.x,
                            y: se.y
                        });
                        cursor = 'nwse-resize';
                        break;
                    case 1: // Top Right
                        this.setSizeByCorners({x: s.x, y: mouseCurY}, {
                            x: mouseCurX,
                            y: se.y
                        });
                        cursor = 'nesw-resize';
                        break;
                    case 2: // Bottom Left
                        this.setSizeByCorners({x: mouseCurX, y: s.y}, {
                            x: se.x,
                            y: mouseCurY
                        });
                        cursor = 'nesw-resize';
                        break;
                    case 3: // Bottom Right
                        this.setSizeByCorners({x: s.x, y: s.y}, {
                            x: mouseCurX,
                            y: mouseCurY
                        });
                        cursor = 'nwse-resize';
